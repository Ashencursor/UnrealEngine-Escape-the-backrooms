...
public:
	...
	FMulticastInlineDelegateProperty_             OnDifficultySwitched;                              // 0x02B0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	void OnDifficultySwitched__DelegateSignature(const class FString& SelectedOption_0);
