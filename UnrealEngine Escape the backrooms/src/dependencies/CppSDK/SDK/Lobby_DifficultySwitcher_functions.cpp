...
void ULobby_DifficultySwitcher_C::OnDifficultySwitched__DelegateSignature(const class FString& SelectedOption_0)
{
	...
	Params::Lobby_DifficultySwitcher_C_OnDifficultySwitched__DelegateSignature Parms{};
