...
struct Lobby_DifficultySwitcher_C_OnDifficultySwitched__DelegateSignature final
{
public:
	class FString                                 SelectedOption_0;                                  // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
};
static_assert(alignof(Lobby_DifficultySwitcher_C_OnDifficultySwitched__DelegateSignature) == 0x000008, "Wrong alignment on Lobby_DifficultySwitcher_C_OnDifficultySwitched__DelegateSignature");
static_assert(sizeof(Lobby_DifficultySwitcher_C_OnDifficultySwitched__DelegateSignature) == 0x000010, "Wrong size on Lobby_DifficultySwitcher_C_OnDifficultySwitched__DelegateSignature");
static_assert(offsetof(Lobby_DifficultySwitcher_C_OnDifficultySwitched__DelegateSignature, SelectedOption_0) == 0x000000, "Member 'Lobby_DifficultySwitcher_C_OnDifficultySwitched__DelegateSignature::SelectedOption_0' has a wrong offset!");
