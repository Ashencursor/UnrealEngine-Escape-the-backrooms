...
struct Lobby_MapSelection_C_OnSwitched_Map__DelegateSignature final
{
public:
	class FString                                 Selected_Map;                                      // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
};
static_assert(alignof(Lobby_MapSelection_C_OnSwitched_Map__DelegateSignature) == 0x000008, "Wrong alignment on Lobby_MapSelection_C_OnSwitched_Map__DelegateSignature");
static_assert(sizeof(Lobby_MapSelection_C_OnSwitched_Map__DelegateSignature) == 0x000010, "Wrong size on Lobby_MapSelection_C_OnSwitched_Map__DelegateSignature");
static_assert(offsetof(Lobby_MapSelection_C_OnSwitched_Map__DelegateSignature, Selected_Map) == 0x000000, "Member 'Lobby_MapSelection_C_OnSwitched_Map__DelegateSignature::Selected_Map' has a wrong offset!");

// Function Lobby_MapSelection.Lobby_MapSelection_C.OnSwitched_Save__DelegateSignature
// 0x0010 (0x0010 - 0x0000)
struct Lobby_MapSelection_C_OnSwitched_Save__DelegateSignature final
{
public:
	class FString                                 SaveName_0;                                        // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
};
static_assert(alignof(Lobby_MapSelection_C_OnSwitched_Save__DelegateSignature) == 0x000008, "Wrong alignment on Lobby_MapSelection_C_OnSwitched_Save__DelegateSignature");
static_assert(sizeof(Lobby_MapSelection_C_OnSwitched_Save__DelegateSignature) == 0x000010, "Wrong size on Lobby_MapSelection_C_OnSwitched_Save__DelegateSignature");
static_assert(offsetof(Lobby_MapSelection_C_OnSwitched_Save__DelegateSignature, SaveName_0) == 0x000000, "Member 'Lobby_MapSelection_C_OnSwitched_Save__DelegateSignature::SaveName_0' has a wrong offset!");

// Function Lobby_MapSelection.Lobby_MapSelection_C.OnSwitched_Difficulty__DelegateSignature
// 0x0001 (0x0001 - 0x0000)
struct Lobby_MapSelection_C_OnSwitched_Difficulty__DelegateSignature final
{
public:
...
static_assert(alignof(Lobby_MapSelection_C_OnSwitched_Difficulty__DelegateSignature) == 0x000001, "Wrong alignment on Lobby_MapSelection_C_OnSwitched_Difficulty__DelegateSignature");
static_assert(sizeof(Lobby_MapSelection_C_OnSwitched_Difficulty__DelegateSignature) == 0x000001, "Wrong size on Lobby_MapSelection_C_OnSwitched_Difficulty__DelegateSignature");
static_assert(offsetof(Lobby_MapSelection_C_OnSwitched_Difficulty__DelegateSignature, Difficulty) == 0x000000, "Member 'Lobby_MapSelection_C_OnSwitched_Difficulty__DelegateSignature::Difficulty' has a wrong offset!");
