...
public:
	...
	bool                                          K2Node_CustomEvent_bEnable_1;                      // 0x0005(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_CustomEvent_bEnable;                        // 0x0006(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_BooleanAND_ReturnValue;                   // 0x0007(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	TArray<struct FTargetsStruct>                 K2Node_ComponentBoundEvent_OutTargets;             // 0x0008(0x0010)(ReferenceParm, ContainsInstancedReference)
	struct FTelemetryStruct                       K2Node_ComponentBoundEvent_OutTelemetry;           // 0x0018(0x0008)(NoDestructor)
	float                                         K2Node_CustomEvent_NewDistance;                    // 0x0020(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                   CallFunc_Conv_FloatToText_ReturnValue_2;           // 0x01C8(0x0018)()
	struct FFormatArgumentData                    K2Node_MakeStruct_FormatArgumentData_3;            // 0x01E0(0x0040)(HasGetValueTypeHash)
	float                                         CallFunc_Divide_FloatFloat_ReturnValue_2;          // 0x0220(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UMaterialInterface*                     CallFunc_GetMaterial_ReturnValue;                  // 0x0250(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<EObjectTypeQuery>                      K2Node_MakeArray_Array_4;                          // 0x0260(0x0010)(ConstParm, ReferenceParm)
	struct FVector                                CallFunc_ScannerTraceCalc_TraceStart;              // 0x0270(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_ScannerTraceCalc_TraceEnd;                // 0x027C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                K2Node_CustomEvent_BeamStart;                      // 0x0288(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                K2Node_CustomEvent_BeamEnd;                        // 0x0294(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_HasAuthority_ReturnValue;                 // 0x02A0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_2A1[0x3];                                      // 0x02A1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_UpdateMinDistance_ReturnValue;            // 0x02A4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         Temp_int_Variable;                                 // 0x02A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Percent_IntInt_ReturnValue;               // 0x02AC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class AActor*>                         K2Node_MakeArray_Array_5;                          // 0x02C0(0x0010)(ConstParm, ReferenceParm)
	struct FHitResult                             CallFunc_LineTraceSingleForObjects_OutHit;         // 0x02D0(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                          CallFunc_LineTraceSingleForObjects_ReturnValue;    // 0x0358(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_359[0x3];                                      // 0x0359(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                CallFunc_Conv_Vector2DToVector_ReturnValue;        // 0x035C(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              CallFunc_FindCollisionUVSkeletalMesh_UV;           // 0x0368(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_FindCollisionUVSkeletalMesh_ReturnValue;  // 0x0370(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_371[0x3];                                      // 0x0371(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLinearColor                           CallFunc_Conv_VectorToLinearColor_ReturnValue;     // 0x0374(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector2D                              CallFunc_FindCollisionUV_UV;                       // 0x0404(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_FindCollisionUV_ReturnValue;              // 0x040C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_40D[0x3];                                      // 0x040D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_FixUVStretching_FixedSize;                // 0x0410(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_FixUVStretching_FixedStretch;             // 0x0414(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           CallFunc_Conv_VectorToLinearColor_ReturnValue_1;   // 0x0420(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_Divide_FloatFloat_ReturnValue_3;          // 0x0434(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Temp_bool_Has_Been_Initd_Variable;                 // 0x0438(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          Temp_bool_IsClosed_Variable;                       // 0x0439(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_43A[0x2];                                      // 0x043A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate;              // 0x043C(0x0010)(ZeroConstructor, NoDestructor)
	...
	bool                                          Temp_bool_Variable;                                // 0x0458(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_459[0x7];                                      // 0x0459(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UTextureRenderTarget2D*                 CallFunc_CheckForExistingRT_RenderTarget;          // 0x0460(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FLinearColor                           CallFunc_Conv_ColorToLinearColor_ReturnValue;      // 0x0470(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           CallFunc_Conv_ColorToLinearColor_ReturnValue_1;    // 0x0480(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         K2Node_Select_Default;                             // 0x0494(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UNiagaraComponent*                      CallFunc_SpawnSystemAttached_ReturnValue;          // 0x0498(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                             K2Node_CustomEvent_HitResult;                      // 0x04A8(0x0088)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FColor                                 K2Node_CustomEvent_Color;                          // 0x0530(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_534[0x4];                                      // 0x0534(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class ABP_ScannerDirector_C*                  CallFunc_GetActorOfClass_ReturnValue;              // 0x0538(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ABP_ScannerDirector_C*                  CallFunc_GetActorOfClass_ReturnValue_1;            // 0x0540(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner) == 0x000548, "Wrong size on BP_Scanner_C_ExecuteUbergraph_BP_Scanner");
...
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_CustomEvent_Enable) == 0x000004, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_CustomEvent_Enable' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_CustomEvent_bEnable_1) == 0x000005, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_CustomEvent_bEnable_1' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_CustomEvent_bEnable) == 0x000006, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_CustomEvent_bEnable' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BooleanAND_ReturnValue) == 0x000007, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_ComponentBoundEvent_OutTargets) == 0x000008, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_ComponentBoundEvent_OutTargets' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_ComponentBoundEvent_OutTelemetry) == 0x000018, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_ComponentBoundEvent_OutTelemetry' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_CustomEvent_NewDistance) == 0x000020, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_CustomEvent_NewDistance' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_FClamp_ReturnValue) == 0x000024, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_FClamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Conv_IntToText_ReturnValue) == 0x000028, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000040, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_MakeStruct_FormatArgumentData) == 0x000048, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_MakeArray_Array) == 0x000088, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Conv_FloatToText_ReturnValue) == 0x000098, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Conv_FloatToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Format_ReturnValue) == 0x0000B0, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_MakeStruct_FormatArgumentData_1) == 0x0000C8, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_MakeArray_Array_1) == 0x000108, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Divide_FloatFloat_ReturnValue_1) == 0x000118, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Divide_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Format_ReturnValue_1) == 0x000120, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Format_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Conv_FloatToText_ReturnValue_1) == 0x000138, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Conv_FloatToText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_MakeStruct_FormatArgumentData_2) == 0x000150, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_MakeStruct_FormatArgumentData_2' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_MakeArray_Array_2) == 0x000190, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_MakeArray_Array_2' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Format_ReturnValue_2) == 0x0001A0, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Format_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Subtract_VectorVector_ReturnValue) == 0x0001B8, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Subtract_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_VSize_ReturnValue) == 0x0001C4, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_VSize_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Conv_FloatToText_ReturnValue_2) == 0x0001C8, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Conv_FloatToText_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_MakeStruct_FormatArgumentData_3) == 0x0001E0, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_MakeStruct_FormatArgumentData_3' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Divide_FloatFloat_ReturnValue_2) == 0x000220, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Divide_FloatFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_MakeArray_Array_3) == 0x000228, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_MakeArray_Array_3' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Format_ReturnValue_3) == 0x000238, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Format_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_GetMaterial_ReturnValue) == 0x000250, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_GetMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_CreateDynamicMaterialInstance_ReturnValue) == 0x000258, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_CreateDynamicMaterialInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_MakeArray_Array_4) == 0x000260, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_MakeArray_Array_4' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_ScannerTraceCalc_TraceStart) == 0x000270, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_ScannerTraceCalc_TraceStart' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_ScannerTraceCalc_TraceEnd) == 0x00027C, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_ScannerTraceCalc_TraceEnd' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_CustomEvent_BeamStart) == 0x000288, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_CustomEvent_BeamStart' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_CustomEvent_BeamEnd) == 0x000294, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_CustomEvent_BeamEnd' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_HasAuthority_ReturnValue) == 0x0002A0, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_UpdateMinDistance_ReturnValue) == 0x0002A4, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_UpdateMinDistance_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, Temp_int_Variable) == 0x0002A8, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Percent_IntInt_ReturnValue) == 0x0002AC, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Percent_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x0002B0, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_Event_DeltaSeconds) == 0x0002B4, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_GetOwner_ReturnValue) == 0x0002B8, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_MakeArray_Array_5) == 0x0002C0, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_MakeArray_Array_5' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_LineTraceSingleForObjects_OutHit) == 0x0002D0, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_LineTraceSingleForObjects_OutHit' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_LineTraceSingleForObjects_ReturnValue) == 0x000358, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_LineTraceSingleForObjects_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Conv_Vector2DToVector_ReturnValue) == 0x00035C, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Conv_Vector2DToVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_FindCollisionUVSkeletalMesh_UV) == 0x000368, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_FindCollisionUVSkeletalMesh_UV' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_FindCollisionUVSkeletalMesh_ReturnValue) == 0x000370, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_FindCollisionUVSkeletalMesh_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Conv_VectorToLinearColor_ReturnValue) == 0x000374, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Conv_VectorToLinearColor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BreakHitResult_bBlockingHit) == 0x000384, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BreakHitResult_bBlockingHit' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BreakHitResult_bInitialOverlap) == 0x000385, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BreakHitResult_bInitialOverlap' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BreakHitResult_Time) == 0x000388, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BreakHitResult_Time' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BreakHitResult_Distance) == 0x00038C, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BreakHitResult_Distance' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BreakHitResult_Location) == 0x000390, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BreakHitResult_Location' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BreakHitResult_ImpactPoint) == 0x00039C, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BreakHitResult_ImpactPoint' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BreakHitResult_Normal) == 0x0003A8, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BreakHitResult_Normal' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BreakHitResult_ImpactNormal) == 0x0003B4, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BreakHitResult_ImpactNormal' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BreakHitResult_PhysMat) == 0x0003C0, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BreakHitResult_PhysMat' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BreakHitResult_HitActor) == 0x0003C8, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BreakHitResult_HitActor' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BreakHitResult_HitComponent) == 0x0003D0, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BreakHitResult_HitComponent' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BreakHitResult_HitBoneName) == 0x0003D8, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BreakHitResult_HitBoneName' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BreakHitResult_HitItem) == 0x0003E0, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BreakHitResult_HitItem' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BreakHitResult_ElementIndex) == 0x0003E4, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BreakHitResult_ElementIndex' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BreakHitResult_FaceIndex) == 0x0003E8, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BreakHitResult_FaceIndex' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BreakHitResult_TraceStart) == 0x0003EC, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BreakHitResult_TraceStart' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_BreakHitResult_TraceEnd) == 0x0003F8, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_BreakHitResult_TraceEnd' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_FindCollisionUV_UV) == 0x000404, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_FindCollisionUV_UV' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_FindCollisionUV_ReturnValue) == 0x00040C, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_FindCollisionUV_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_FixUVStretching_FixedSize) == 0x000410, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_FixUVStretching_FixedSize' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_FixUVStretching_FixedStretch) == 0x000414, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_FixUVStretching_FixedStretch' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Conv_VectorToLinearColor_ReturnValue_1) == 0x000420, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Conv_VectorToLinearColor_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_IsValid_ReturnValue) == 0x000430, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_IsValid_ReturnValue_1) == 0x000431, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Divide_FloatFloat_ReturnValue_3) == 0x000434, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Divide_FloatFloat_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, Temp_bool_Has_Been_Initd_Variable) == 0x000438, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::Temp_bool_Has_Been_Initd_Variable' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, Temp_bool_IsClosed_Variable) == 0x000439, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::Temp_bool_IsClosed_Variable' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_CreateDelegate_OutputDelegate) == 0x00043C, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x00044C, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000450, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, Temp_bool_Variable) == 0x000458, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_CheckForExistingRT_RenderTarget) == 0x000460, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_CheckForExistingRT_RenderTarget' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_IsValid_ReturnValue_2) == 0x000468, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Add_IntInt_ReturnValue) == 0x00046C, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Conv_ColorToLinearColor_ReturnValue) == 0x000470, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Conv_ColorToLinearColor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Conv_ColorToLinearColor_ReturnValue_1) == 0x000480, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Conv_ColorToLinearColor_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_Multiply_FloatFloat_ReturnValue_1) == 0x000490, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_Multiply_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_Select_Default) == 0x000494, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_SpawnSystemAttached_ReturnValue) == 0x000498, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_SpawnSystemAttached_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_SpawnSoundAttached_ReturnValue) == 0x0004A0, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_SpawnSoundAttached_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_CustomEvent_HitResult) == 0x0004A8, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_CustomEvent_HitResult' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, K2Node_CustomEvent_Color) == 0x000530, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::K2Node_CustomEvent_Color' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_GetActorOfClass_ReturnValue) == 0x000538, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_GetActorOfClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Scanner_C_ExecuteUbergraph_BP_Scanner, CallFunc_GetActorOfClass_ReturnValue_1) == 0x000540, "Member 'BP_Scanner_C_ExecuteUbergraph_BP_Scanner::CallFunc_GetActorOfClass_ReturnValue_1' has a wrong offset!");
