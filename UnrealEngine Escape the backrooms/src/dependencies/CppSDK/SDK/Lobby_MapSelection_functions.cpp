...
void ULobby_MapSelection_C::OnSwitched_Map__DelegateSignature(const class FString& Selected_Map)
{
	...
	Params::Lobby_MapSelection_C_OnSwitched_Map__DelegateSignature Parms{};

	Parms.Selected_Map = std::move(Selected_Map);
...
void ULobby_MapSelection_C::OnSwitched_Save__DelegateSignature(const class FString& SaveName_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::Lobby_MapSelection_C_OnSwitched_Save__DelegateSignature Parms{};
...
void ULobby_MapSelection_C::OnSwitched_Difficulty__DelegateSignature(E_Difficulty Difficulty)
{
	static class UFunction* Func = nullptr;
	...
	Params::Lobby_MapSelection_C_OnSwitched_Difficulty__DelegateSignature Parms{};
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class FString                           Slot_0                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
// bool                                    CallDelegate_                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
