...
#include "BTDecorator_ShouldMove_classes.hpp"
#include "BTDecorator_ShouldMove_parameters.hpp"
...
bool BTDecorator_ShouldMove::UBTDecorator_ShouldMove_C::PerformConditionCheckAI(class AAIController* OwnerController, class APawn* ControlledPawn)
{
