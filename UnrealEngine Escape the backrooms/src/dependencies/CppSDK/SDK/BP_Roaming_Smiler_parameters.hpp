...
public:
	...
	class AAIC_Roaming_Smiler_C*                  K2Node_DynamicCast_AsAIC_Roaming_Smiler;           // 0x0018(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0020(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0021(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_22[0x2];                                       // 0x0022(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(class UEnvQueryInstanceBlueprintWrapper* QueryInstance, EEnvQueryStatus QueryStatus)> K2Node_CreateDelegate_OutputDelegate;              // 0x0024(0x0010)(ZeroConstructor, NoDestructor)
	...
	float                                         CallFunc_PlayAnimMontage_ReturnValue;              // 0x00A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler, Temp_bool_Has_Been_Initd_Variable) == 0x000004, "Member 'BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler::Temp_bool_Has_Been_Initd_Variable' has a wrong offset!");
static_assert(offsetof(BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler, Temp_bool_IsClosed_Variable) == 0x000005, "Member 'BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler::Temp_bool_IsClosed_Variable' has a wrong offset!");
static_assert(offsetof(BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler, CallFunc_HasAuthority_ReturnValue) == 0x000006, "Member 'BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler, CallFunc_GetAIController_ReturnValue) == 0x000008, "Member 'BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler::CallFunc_GetAIController_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler, K2Node_CustomEvent_Player) == 0x000010, "Member 'BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler::K2Node_CustomEvent_Player' has a wrong offset!");
static_assert(offsetof(BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler, K2Node_DynamicCast_AsAIC_Roaming_Smiler) == 0x000018, "Member 'BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler::K2Node_DynamicCast_AsAIC_Roaming_Smiler' has a wrong offset!");
static_assert(offsetof(BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler, K2Node_DynamicCast_bSuccess) == 0x000020, "Member 'BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler, CallFunc_IsValid_ReturnValue) == 0x000021, "Member 'BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler, K2Node_CreateDelegate_OutputDelegate) == 0x000024, "Member 'BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
static_assert(offsetof(BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler, CallFunc_PlayAnimMontage_ReturnValue) == 0x0000A8, "Member 'BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler::CallFunc_PlayAnimMontage_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler, CallFunc_EqualEqual_FloatFloat_ReturnValue) == 0x0000AC, "Member 'BP_Roaming_Smiler_C_ExecuteUbergraph_BP_Roaming_Smiler::CallFunc_EqualEqual_FloatFloat_ReturnValue' has a wrong offset!");
