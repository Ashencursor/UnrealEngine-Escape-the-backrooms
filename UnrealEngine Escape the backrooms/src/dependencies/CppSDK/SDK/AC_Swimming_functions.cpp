...
// Parameters:
// bool                                    Is_in_Water_0                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UAC_Swimming_C::Is_In_Water_Event__DelegateSignature(bool Is_in_Water_0)
{
	...
	Params::AC_Swimming_C_Is_In_Water_Event__DelegateSignature Parms{};

	Parms.Is_in_Water_0 = Is_in_Water_0;
...
// (Public, Delegate, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    Is_Underwater_0                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UAC_Swimming_C::Is_Underwater_Event__DelegateSignature(bool Is_Underwater_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::AC_Swimming_C_Is_Underwater_Event__DelegateSignature Parms{};

	Parms.Is_Underwater_0 = Is_Underwater_0;
