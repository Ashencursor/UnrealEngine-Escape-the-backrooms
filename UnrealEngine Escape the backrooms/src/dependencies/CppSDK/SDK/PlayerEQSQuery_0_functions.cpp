...
#include "PlayerEQSQuery_0_classes.hpp"
...
void PlayerEQSQuery_0::UPlayerEQSQuery_C::ProvideActorsSet(class UObject* QuerierObject, class AActor* QuerierActor, TArray<class AActor*>* ResultingActorsSet) const
{
