...
public:
	...
	class ABP_RowBoat_C*                          CurrentTarget;                                     // 0x02A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void Retry();
	void OnSpawn(class UEnvQueryInstanceBlueprintWrapper* QueryInstance, EEnvQueryStatus QueryStatus);
	void StopSpawnTimer();
	void StopSpawning();
