...
#include "BTDecorator_ShouldMove_0_classes.hpp"
...
bool BTDecorator_ShouldMove_0::UBTDecorator_ShouldMove_C::PerformConditionCheckAI(class AAIController* OwnerController, class APawn* ControlledPawn)
{
