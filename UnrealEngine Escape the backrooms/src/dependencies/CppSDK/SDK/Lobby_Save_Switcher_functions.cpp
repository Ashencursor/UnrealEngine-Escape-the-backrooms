...
void ULobby_Save_Switcher_C::OnSaveSwitched__DelegateSignature(const class FString& SelectedOption_0)
{
	...
	Params::Lobby_Save_Switcher_C_OnSaveSwitched__DelegateSignature Parms{};
