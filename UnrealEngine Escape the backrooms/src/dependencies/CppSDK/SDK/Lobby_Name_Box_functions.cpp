...
void ULobby_Name_Box_C::OnNameSwitched__DelegateSignature(const class FText& SelectedOption)
{
	...
	Params::Lobby_Name_Box_C_OnNameSwitched__DelegateSignature Parms{};
