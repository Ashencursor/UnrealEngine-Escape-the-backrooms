...
static_assert(offsetof(SequenceDirector_C_ExecuteUbergraph_SequenceDirector, CallFunc_GetGameMode_ReturnValue) == 0x000008, "Member 'SequenceDirector_C_ExecuteUbergraph_SequenceDirector::CallFunc_GetGameMode_ReturnValue' has a wrong offset!");
static_assert(offsetof(SequenceDirector_C_ExecuteUbergraph_SequenceDirector, K2Node_DynamicCast_AsMP_Level_94) == 0x000010, "Member 'SequenceDirector_C_ExecuteUbergraph_SequenceDirector::K2Node_DynamicCast_AsMP_Level_94' has a wrong offset!");
...
static_assert(offsetof(SequenceDirector_C_ExecuteUbergraph_SequenceDirector, CallFunc_IsStandalone_ReturnValue) == 0x000019, "Member 'SequenceDirector_C_ExecuteUbergraph_SequenceDirector::CallFunc_IsStandalone_ReturnValue' has a wrong offset!");
