...
static_assert(offsetof(BP_Storm_Volume_C_ExecuteUbergraph_BP_Storm_Volume, Temp_bool_Has_Been_Initd_Variable) == 0x000018, "Member 'BP_Storm_Volume_C_ExecuteUbergraph_BP_Storm_Volume::Temp_bool_Has_Been_Initd_Variable' has a wrong offset!");
...
static_assert(offsetof(BP_Storm_Volume_C_ExecuteUbergraph_BP_Storm_Volume, CallFunc_HasAuthority_ReturnValue) == 0x000020, "Member 'BP_Storm_Volume_C_ExecuteUbergraph_BP_Storm_Volume::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Storm_Volume_C_ExecuteUbergraph_BP_Storm_Volume, Temp_bool_IsClosed_Variable) == 0x000021, "Member 'BP_Storm_Volume_C_ExecuteUbergraph_BP_Storm_Volume::Temp_bool_IsClosed_Variable' has a wrong offset!");
static_assert(offsetof(BP_Storm_Volume_C_ExecuteUbergraph_BP_Storm_Volume, CallFunc_HasAuthority_ReturnValue_1) == 0x000022, "Member 'BP_Storm_Volume_C_ExecuteUbergraph_BP_Storm_Volume::CallFunc_HasAuthority_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(BP_Storm_Volume_C_ExecuteUbergraph_BP_Storm_Volume, Temp_bool_Has_Been_Initd_Variable_1) == 0x000073, "Member 'BP_Storm_Volume_C_ExecuteUbergraph_BP_Storm_Volume::Temp_bool_Has_Been_Initd_Variable_1' has a wrong offset!");
...
static_assert(offsetof(BP_Storm_Volume_C_ExecuteUbergraph_BP_Storm_Volume, Temp_bool_IsClosed_Variable_1) == 0x00008C, "Member 'BP_Storm_Volume_C_ExecuteUbergraph_BP_Storm_Volume::Temp_bool_IsClosed_Variable_1' has a wrong offset!");
static_assert(offsetof(BP_Storm_Volume_C_ExecuteUbergraph_BP_Storm_Volume, CallFunc_Add_IntInt_ReturnValue) == 0x000090, "Member 'BP_Storm_Volume_C_ExecuteUbergraph_BP_Storm_Volume::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Storm_Volume_C_ExecuteUbergraph_BP_Storm_Volume, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000094, "Member 'BP_Storm_Volume_C_ExecuteUbergraph_BP_Storm_Volume::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
