...
public:
	...
	bool                                          IsUsable;                                          // 0x0298(0x0001)(Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	float                                         InteractDelay;                                     // 0x029C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                VROffset;                                          // 0x02A0(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ShouldCheck;                                       // 0x02AC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          HideCursor;                                        // 0x02AD(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ShouldHidePlayer;                                  // 0x02AE(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ShouldStopMovement;                                // 0x02AF(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class ACharacter*                             InteractingPlayer;                                 // 0x02B0(0x0008)(Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class APlayerController*                      InteractingController;                             // 0x02B8(0x0008)(Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C0[0x8];                                      // 0x02C0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UInteractableCameraComponent*           InteractableCameraComponent;                       // 0x02C8(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMotionControllerComponent*             LeftGrip;                                          // 0x02D0(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMotionControllerComponent*             RightGrip;                                         // 0x02D8(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AInteractablePawn) == 0x0002E0, "Wrong size on AInteractablePawn");
...
static_assert(offsetof(AInteractablePawn, InteractDelay) == 0x00029C, "Member 'AInteractablePawn::InteractDelay' has a wrong offset!");
static_assert(offsetof(AInteractablePawn, VROffset) == 0x0002A0, "Member 'AInteractablePawn::VROffset' has a wrong offset!");
static_assert(offsetof(AInteractablePawn, ShouldCheck) == 0x0002AC, "Member 'AInteractablePawn::ShouldCheck' has a wrong offset!");
static_assert(offsetof(AInteractablePawn, HideCursor) == 0x0002AD, "Member 'AInteractablePawn::HideCursor' has a wrong offset!");
static_assert(offsetof(AInteractablePawn, ShouldHidePlayer) == 0x0002AE, "Member 'AInteractablePawn::ShouldHidePlayer' has a wrong offset!");
static_assert(offsetof(AInteractablePawn, ShouldStopMovement) == 0x0002AF, "Member 'AInteractablePawn::ShouldStopMovement' has a wrong offset!");
static_assert(offsetof(AInteractablePawn, InteractingPlayer) == 0x0002B0, "Member 'AInteractablePawn::InteractingPlayer' has a wrong offset!");
static_assert(offsetof(AInteractablePawn, InteractingController) == 0x0002B8, "Member 'AInteractablePawn::InteractingController' has a wrong offset!");
static_assert(offsetof(AInteractablePawn, InteractableCameraComponent) == 0x0002C8, "Member 'AInteractablePawn::InteractableCameraComponent' has a wrong offset!");
static_assert(offsetof(AInteractablePawn, LeftGrip) == 0x0002D0, "Member 'AInteractablePawn::LeftGrip' has a wrong offset!");
static_assert(offsetof(AInteractablePawn, RightGrip) == 0x0002D8, "Member 'AInteractablePawn::RightGrip' has a wrong offset!");
...
{
public:
	class UBoxComponent*                          RootBoxComponent;                                  // 0x02E0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UArrowComponent*                        ArrowComponent;                                    // 0x02E8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UBoatComponent*                         BoatComponent;                                     // 0x02F0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UStaticMeshComponent*                   BoatMaskMesh;                                      // 0x02F8(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ABoatPawn) == 0x000300, "Wrong size on ABoatPawn");
static_assert(offsetof(ABoatPawn, RootBoxComponent) == 0x0002E0, "Member 'ABoatPawn::RootBoxComponent' has a wrong offset!");
static_assert(offsetof(ABoatPawn, ArrowComponent) == 0x0002E8, "Member 'ABoatPawn::ArrowComponent' has a wrong offset!");
static_assert(offsetof(ABoatPawn, BoatComponent) == 0x0002F0, "Member 'ABoatPawn::BoatComponent' has a wrong offset!");
static_assert(offsetof(ABoatPawn, BoatMaskMesh) == 0x0002F8, "Member 'ABoatPawn::BoatMaskMesh' has a wrong offset!");
...
public:
	...
	bool                                          IsUsable;                                          // 0x0240(0x0001)(Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AClientInteractablePawn) == 0x0002E0, "Wrong size on AClientInteractablePawn");
...
static_assert(sizeof(AFancyCharacter) == 0x000510, "Wrong size on AFancyCharacter");
...
public:
	...
	class UMissionData*                           MissionData;                                       // 0x0240(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UFancyGameInstance) == 0x000248, "Wrong size on UFancyGameInstance");
...
static_assert(offsetof(UFancyGameInstance, MissionData) == 0x000240, "Member 'UFancyGameInstance::MissionData' has a wrong offset!");
...
static_assert(sizeof(AFancyGameMode) == 0x000318, "Wrong size on AFancyGameMode");
...
static_assert(sizeof(AFancyPlayerController) == 0x000570, "Wrong size on AFancyPlayerController");
...
public:
	...
	bool                                          IsThermometer;                                     // 0x0294(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UFancySpringArmComponent, IsThermometer) == 0x000294, "Member 'UFancySpringArmComponent::IsThermometer' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             BP_ScannerTrace;                                   // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             BP_UpdateColors;                                   // 0x00C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
// 0x0000 (0x0028 - 0x0028)
class IMapEditorInterface final : public IInterface
{
public:
	void OnDeleted();
	void OnGrabbed();
...
static_assert(alignof(IMapEditorInterface) == 0x000008, "Wrong alignment on IMapEditorInterface");
static_assert(sizeof(IMapEditorInterface) == 0x000028, "Wrong size on IMapEditorInterface");
...
public:
	...
	float                                         LevelBaseXP;                                       // 0x0038(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         LevelTimeLimit;                                    // 0x003C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         TimeCompleted;                                     // 0x0040(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         PlayerDeaths;                                      // 0x0044(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         EntitySightings;                                   // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         LowSanityAmount;                                   // 0x004C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         XPPenalty;                                         // 0x0050(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_54[0x4];                                       // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 MissionDataRowName;                                // 0x0058(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMissionData, LevelBaseXP) == 0x000038, "Member 'UMissionData::LevelBaseXP' has a wrong offset!");
static_assert(offsetof(UMissionData, LevelTimeLimit) == 0x00003C, "Member 'UMissionData::LevelTimeLimit' has a wrong offset!");
static_assert(offsetof(UMissionData, TimeCompleted) == 0x000040, "Member 'UMissionData::TimeCompleted' has a wrong offset!");
static_assert(offsetof(UMissionData, PlayerDeaths) == 0x000044, "Member 'UMissionData::PlayerDeaths' has a wrong offset!");
static_assert(offsetof(UMissionData, EntitySightings) == 0x000048, "Member 'UMissionData::EntitySightings' has a wrong offset!");
static_assert(offsetof(UMissionData, LowSanityAmount) == 0x00004C, "Member 'UMissionData::LowSanityAmount' has a wrong offset!");
static_assert(offsetof(UMissionData, XPPenalty) == 0x000050, "Member 'UMissionData::XPPenalty' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnScannerWaveUpdate;                               // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	float                                         CheckMotionRate;                                   // 0x02E0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2E4[0x4];                                      // 0x02E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AActor*>                         IgnoredActorsArr;                                  // 0x02E8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class URadarPlayerComponent*>          AllRadarComponentsArr;                             // 0x02F8(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	struct FTimerHandle                           CheckMotion_Handle;                                // 0x0308(0x0008)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsLocalController;                                // 0x0310(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_311[0x7];                                      // 0x0311(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTimerHandle                           RegisterComponent_Handle;                          // 0x0318(0x0008)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         TryRegister;                                       // 0x0320(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_324[0x4];                                      // 0x0324(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AMotionScannerDirector*                 ScannerDirector;                                   // 0x0328(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FRadarTargetStruct>             TargetsArr;                                        // 0x0330(0x0010)(ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	float                                         CheckTargetsRate;                                  // 0x0340(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_344[0x4];                                      // 0x0344(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FRadarTargetStruct>             VisibleTargetsArr;                                 // 0x0348(0x0010)(ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TArray<struct FRadarTargetStruct>             LastTargetsArr;                                    // 0x0358(0x0010)(ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	struct FTelemetryStruct                       TelemetryScanner;                                  // 0x0368(0x0008)(NoDestructor, NativeAccessSpecifierPrivate)
	bool                                          bResetValue;                                       // 0x0370(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_371[0x3];                                      // 0x0371(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         WaveMultiply;                                      // 0x0374(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(ARadarMap) == 0x000378, "Wrong size on ARadarMap");
static_assert(offsetof(ARadarMap, CheckMotionRate) == 0x0002E0, "Member 'ARadarMap::CheckMotionRate' has a wrong offset!");
static_assert(offsetof(ARadarMap, IgnoredActorsArr) == 0x0002E8, "Member 'ARadarMap::IgnoredActorsArr' has a wrong offset!");
static_assert(offsetof(ARadarMap, AllRadarComponentsArr) == 0x0002F8, "Member 'ARadarMap::AllRadarComponentsArr' has a wrong offset!");
static_assert(offsetof(ARadarMap, CheckMotion_Handle) == 0x000308, "Member 'ARadarMap::CheckMotion_Handle' has a wrong offset!");
static_assert(offsetof(ARadarMap, bIsLocalController) == 0x000310, "Member 'ARadarMap::bIsLocalController' has a wrong offset!");
static_assert(offsetof(ARadarMap, RegisterComponent_Handle) == 0x000318, "Member 'ARadarMap::RegisterComponent_Handle' has a wrong offset!");
static_assert(offsetof(ARadarMap, TryRegister) == 0x000320, "Member 'ARadarMap::TryRegister' has a wrong offset!");
static_assert(offsetof(ARadarMap, ScannerDirector) == 0x000328, "Member 'ARadarMap::ScannerDirector' has a wrong offset!");
static_assert(offsetof(ARadarMap, TargetsArr) == 0x000330, "Member 'ARadarMap::TargetsArr' has a wrong offset!");
static_assert(offsetof(ARadarMap, CheckTargetsRate) == 0x000340, "Member 'ARadarMap::CheckTargetsRate' has a wrong offset!");
static_assert(offsetof(ARadarMap, VisibleTargetsArr) == 0x000348, "Member 'ARadarMap::VisibleTargetsArr' has a wrong offset!");
static_assert(offsetof(ARadarMap, LastTargetsArr) == 0x000358, "Member 'ARadarMap::LastTargetsArr' has a wrong offset!");
static_assert(offsetof(ARadarMap, TelemetryScanner) == 0x000368, "Member 'ARadarMap::TelemetryScanner' has a wrong offset!");
static_assert(offsetof(ARadarMap, bResetValue) == 0x000370, "Member 'ARadarMap::bResetValue' has a wrong offset!");
static_assert(offsetof(ARadarMap, WaveMultiply) == 0x000374, "Member 'ARadarMap::WaveMultiply' has a wrong offset!");
