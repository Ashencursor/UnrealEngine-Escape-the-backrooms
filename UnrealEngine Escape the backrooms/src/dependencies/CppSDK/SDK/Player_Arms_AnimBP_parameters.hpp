...
public:
	...
	bool                                          CallFunc_IsSwimming_ReturnValue;                   // 0x00F4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP, CallFunc_Not_PreBool_ReturnValue) == 0x000004, "Member 'Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP, CallFunc_Less_FloatFloat_ReturnValue) == 0x000005, "Member 'Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP::CallFunc_Less_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP, CallFunc_BooleanOR_ReturnValue) == 0x000006, "Member 'Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP, K2Node_Event_DeltaTimeX) == 0x000008, "Member 'Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP::K2Node_Event_DeltaTimeX' has a wrong offset!");
...
static_assert(offsetof(Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP, CallFunc_Not_PreBool_ReturnValue_1) == 0x0000F1, "Member 'Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP, CallFunc_BooleanAND_ReturnValue) == 0x0000F2, "Member 'Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP, CallFunc_BooleanAND_ReturnValue_1) == 0x0000F3, "Member 'Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP, CallFunc_IsSwimming_ReturnValue) == 0x0000F4, "Member 'Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP::CallFunc_IsSwimming_ReturnValue' has a wrong offset!");
static_assert(offsetof(Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP, CallFunc_GreaterEqual_FloatFloat_ReturnValue) == 0x0000F5, "Member 'Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP::CallFunc_GreaterEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP, CallFunc_BooleanAND_ReturnValue_2) == 0x0000F6, "Member 'Player_Arms_AnimBP_C_ExecuteUbergraph_Player_Arms_AnimBP::CallFunc_BooleanAND_ReturnValue_2' has a wrong offset!");
