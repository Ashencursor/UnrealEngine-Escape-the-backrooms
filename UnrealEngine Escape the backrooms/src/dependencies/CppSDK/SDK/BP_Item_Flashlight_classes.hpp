...
public:
	...
	class USpotLightComponent*                    FlashlightFakeGI;                                  // 0x0260(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class USpotLightComponent*                    Flashlight;                                        // 0x0268(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class USpringArmComponent*                    FlashlightArm;                                     // 0x0270(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(ABP_Item_Flashlight_C, FlashlightFakeGI) == 0x000260, "Member 'ABP_Item_Flashlight_C::FlashlightFakeGI' has a wrong offset!");
static_assert(offsetof(ABP_Item_Flashlight_C, Flashlight) == 0x000268, "Member 'ABP_Item_Flashlight_C::Flashlight' has a wrong offset!");
static_assert(offsetof(ABP_Item_Flashlight_C, FlashlightArm) == 0x000270, "Member 'ABP_Item_Flashlight_C::FlashlightArm' has a wrong offset!");
