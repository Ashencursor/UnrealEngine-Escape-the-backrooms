...
void UWBP_Button_Basic_C::ButtonPressed__DelegateSignature(const class FText& ButtonText_0, EModifierKeys Modifier)
{
	...
	Params::WBP_Button_Basic_C_ButtonPressed__DelegateSignature Parms{};
