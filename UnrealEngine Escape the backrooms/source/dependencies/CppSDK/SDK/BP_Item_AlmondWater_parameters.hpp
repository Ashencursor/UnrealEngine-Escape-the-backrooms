...
public:
	...
	class AFancyCharacter*                        K2Node_DynamicCast_AsFancy_Character;              // 0x0080(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class FName NotifyName)>       K2Node_CreateDelegate_OutputDelegate_4;            // 0x00D0(0x0010)(ZeroConstructor, NoDestructor)
	...
	class AMP_PS_C*                               K2Node_DynamicCast_AsMP_PS;                        // 0x00F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          K2Node_Event_Enable;                               // 0x0108(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	EEventType                                    K2Node_Event_EventType;                            // 0x0109(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater) == 0x000008, "Wrong alignment on BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater");
static_assert(sizeof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater) == 0x000110, "Wrong size on BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater");
...
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_CustomEvent_NotifyName_3) == 0x00000C, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_CustomEvent_NotifyName_3' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_CreateDelegate_OutputDelegate) == 0x000014, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_CustomEvent_NotifyName_2) == 0x000024, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_CustomEvent_NotifyName_2' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_CreateDelegate_OutputDelegate_1) == 0x00002C, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_CustomEvent_NotifyName_1) == 0x00003C, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_CustomEvent_NotifyName_1' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_CreateDelegate_OutputDelegate_2) == 0x000044, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_CustomEvent_NotifyName) == 0x000054, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_CustomEvent_NotifyName' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_CreateDelegate_OutputDelegate_3) == 0x00005C, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_CreateDelegate_OutputDelegate_3' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, Temp_name_Variable) == 0x00006C, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::Temp_name_Variable' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, CallFunc_GetAttachParentActor_ReturnValue) == 0x000078, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::CallFunc_GetAttachParentActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_DynamicCast_AsFancy_Character) == 0x000080, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_DynamicCast_AsFancy_Character' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_DynamicCast_bSuccess) == 0x000088, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, CallFunc_IsLocallyControlled_ReturnValue) == 0x000089, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::CallFunc_IsLocallyControlled_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, CallFunc_CreateProxyObjectForPlayMontage_ReturnValue) == 0x000090, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::CallFunc_CreateProxyObjectForPlayMontage_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, CallFunc_IsValid_ReturnValue) == 0x000098, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_CustomEvent_Target) == 0x0000A0, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_CustomEvent_Target' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_CustomEvent_Character) == 0x0000A8, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_CustomEvent_Character' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_DynamicCast_AsBP_Breakable) == 0x0000B0, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_DynamicCast_AsBP_Breakable' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_DynamicCast_bSuccess_1) == 0x0000C0, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, CallFunc_GetOwner_ReturnValue) == 0x0000C8, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_CreateDelegate_OutputDelegate_4) == 0x0000D0, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_CreateDelegate_OutputDelegate_4' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_DynamicCast_AsBPCharacter_Demo) == 0x0000E0, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_DynamicCast_AsBPCharacter_Demo' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_DynamicCast_bSuccess_2) == 0x0000E8, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_DynamicCast_AsMP_PS) == 0x0000F0, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_DynamicCast_AsMP_PS' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_DynamicCast_bSuccess_3) == 0x0000F8, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_DynamicCast_bSuccess_3' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, CallFunc_SpawnSoundAttached_ReturnValue) == 0x000100, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::CallFunc_SpawnSoundAttached_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_Event_Enable) == 0x000108, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_Event_Enable' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater, K2Node_Event_EventType) == 0x000109, "Member 'BP_Item_AlmondWater_C_ExecuteUbergraph_BP_Item_AlmondWater::K2Node_Event_EventType' has a wrong offset!");
...
static_assert(alignof(BP_Item_AlmondWater_C_SetMaterial) == 0x000008, "Wrong alignment on BP_Item_AlmondWater_C_SetMaterial");
static_assert(sizeof(BP_Item_AlmondWater_C_SetMaterial) == 0x000030, "Wrong size on BP_Item_AlmondWater_C_SetMaterial");
...
static_assert(offsetof(BP_Item_AlmondWater_C_SetMaterial, Temp_bool_Variable) == 0x000002, "Member 'BP_Item_AlmondWater_C_SetMaterial::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_SetMaterial, Temp_object_Variable) == 0x000008, "Member 'BP_Item_AlmondWater_C_SetMaterial::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_SetMaterial, Temp_bool_Variable_1) == 0x000010, "Member 'BP_Item_AlmondWater_C_SetMaterial::Temp_bool_Variable_1' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_SetMaterial, Temp_object_Variable_1) == 0x000018, "Member 'BP_Item_AlmondWater_C_SetMaterial::Temp_object_Variable_1' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_SetMaterial, K2Node_Select_Default) == 0x000020, "Member 'BP_Item_AlmondWater_C_SetMaterial::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(BP_Item_AlmondWater_C_SetMaterial, K2Node_Select_Default_1) == 0x000028, "Member 'BP_Item_AlmondWater_C_SetMaterial::K2Node_Select_Default_1' has a wrong offset!");
