...
public:
	...
	TArray<class ALobby_PlayerController_C*>      PlayerControllers;                                 // 0x0318(0x0010)(Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance)
...
public:
	...
	void Handle_PlayerDisconnection(class UObject* Player);
