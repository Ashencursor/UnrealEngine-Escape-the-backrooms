...
public:
	...
	class UBP_SG_GameSettings_C*                  CallFunc_LoadSettings_SaveGame;                    // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_FL_GameSettings_C_Load_ControlSettings) == 0x000030, "Wrong size on BP_FL_GameSettings_C_Load_ControlSettings");
...
static_assert(offsetof(BP_FL_GameSettings_C_Load_ControlSettings, CallFunc_LoadSettings_SaveGame) == 0x000020, "Member 'BP_FL_GameSettings_C_Load_ControlSettings::CallFunc_LoadSettings_SaveGame' has a wrong offset!");
static_assert(offsetof(BP_FL_GameSettings_C_Load_ControlSettings, CallFunc_FClamp_ReturnValue) == 0x000028, "Member 'BP_FL_GameSettings_C_Load_ControlSettings::CallFunc_FClamp_ReturnValue' has a wrong offset!");
